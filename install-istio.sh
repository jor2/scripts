...
sudo kubectl patch svc -n istio-system istio-ingressgateway --type='json' -p '[{"op":"replace","path":"/spec/type","value":"NodePort"}]'
echo "kubectl get svc -n istio-system"
kubectl get svc -n istio-system
echo "kubectl get pods -n istio-system"
kubectl get pods -n istio-system
echo "sudo kubectl describe svc -n istio-system istio-ingressgateway"
